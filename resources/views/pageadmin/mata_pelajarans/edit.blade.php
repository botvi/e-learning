                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Edit Master Mata Pelajaran</h5>
                        </div>
                        <hr>
                            <form action="{{ route('mata_pelajarans.update', $mataPelajaran->id) }}" method="POST" class="row g-3">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                                <label for="kode_pelajaran" class="form-label">Kode Pelajaran</label>
                                <input type="number" class="form-control" id="kode_pelajaran" name="kode_pelajaran" value="{{ old('kode_pelajaran', $mataPelajaran->kode_pelajaran) }}" required>
                            </div>
                            <div class="col-md-12">
